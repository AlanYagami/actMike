        ...
        <Navbar fluid rounded style={{backgroundColor:"gray"}}>
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              inline
              label={
                <Avatar alt="User settings" img="https://media.istockphoto.com/id/664373658/es/foto/alien.jpg?s=612x612&w=0&k=20&c=NLd_atwFqwYgfi9isYS9k_PT3Z3re0h6lXSmHyg3cdE=" rounded />
              }
            >
              <Dropdown.Header>
                <span className="block text-sm">AlanYagamiGG</span>
                <span className="block truncate text-sm font-medium">alancindragon10@gmail.com</span>
              </Dropdown.Header>
